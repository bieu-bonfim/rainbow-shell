...
class Enderecos extends Core{
    ...
    public function inserirEndereco($cep, $logradouro, $numero, $complemento, $bairro, $cidade, $estado, $idCliente)
    {
        

        $sql = "INSERT INTO `tbl_endereco`(`id_endereco`, `cep`, `logradouro`, `numero`, `complemento`, `bairro`, `cidade`, `estado`, `endereco_id_usuario`) 
                                    VALUES (null, :cep, :logradouro, :numero, :complemento, :bairro, :cidade, :estado, :idCliente)";
